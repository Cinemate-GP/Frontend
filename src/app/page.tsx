              ...
              >
                {token ? (
                  ...
                  >
                    ...
                    <motion.div className="absolute inset-0 bg-gradient-to-r from-red-600 to-red-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  ...
                  <motion.div
                    ...
                    animate={{
                      boxShadow: [
                        ...
                        "0 20px 80px -12px rgba(220,38,38,0.25)",
                        "0 20px 50px -12px rgba(220,38,38,0.15)",
                      ],
                    }}
                    transition={{
                ...
                {[...Array(20)].map((_, i) => (
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow:
                        i % 3 === 0 ? "0 0 8px rgba(239, 68, 68, 0.5)" : "none",

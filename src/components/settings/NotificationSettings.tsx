      ...
      <div className="space-y-4 sm:space-y-5">
        ...
        <div className="flex items-center justify-between py-3 border-b border-zinc-800">
          <div className="flex items-start sm:items-center gap-2 sm:gap-3">
            ...
            <div>
              <p className="text-gray-300 text-sm sm:text-base">Push Notifications</p>
        ...
        <div className="pt-3">
          <h3 className="text-gray-300 mb-4 pb-2 border-b border-zinc-800 text-sm sm:text-base font-medium">Notification Types</h3>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-start sm:items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm sm:text-base">New Releases</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-start sm:items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm sm:text-base">Activity Updates</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-start sm:items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm sm:text-base">Friend Activity</p>

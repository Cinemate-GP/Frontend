    ...
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        const updatedUser = {
          ...
          bio: data.bio,
          socialMedia: {
            instagram: data.socialMedia?.instagram || user.socialMedia?.instagram,
            twitter: data.socialMedia?.twitter || user.socialMedia?.twitter,
            linkedin: data.socialMedia?.linkedin || user.socialMedia?.linkedin,
          },
        };
        ...
        <form onSubmit={handleUpdate} className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 py-4 border-b border-zinc-800">
            ...
            <div className="flex-1 text-center sm:text-left">
              <h3 className="text-gray-300 text-lg mb-2">Profile Photo</h3>
              <p className="text-gray-500 text-sm mb-3">Click on the image to change your profile photo</p>
              <button
                type="button"
                onClick={handleImageClick}
                className="text-sm bg-zinc-800 hover:bg-zinc-700 px-3 py-1.5 rounded text-gray-300 transition-colors"
              >
                Upload New Photo
              </button>
            </div>
          ...
          {/* Name */}
          <div className="flex flex-col py-3 border-b border-zinc-800">
          ...
          <div className="flex flex-col py-3 border-b border-zinc-800">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                <label htmlFor="bio" className="block text-gray-300 mb-1">Biography</label>

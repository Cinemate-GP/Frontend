...
// Commented out unused imports since overview is disabled
...
const FeedStats: React.FC<FeedStatsProps> = ({ feeds = [] }) => {
  // Commented out the getStatsData function since overview is disabled
  // const getStatsData = () => {
  //   const stats = {
  //     total: feeds.length,
  ...
  return (
    // Commented out the activity overview section
    null
